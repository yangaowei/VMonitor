...
func (collector MemoryCollector) Name() string {
	return "Memory"
}

func (collector MemoryCollector) Collect(vm models.VirtualMachine) (interface{}, error) {
...
func Initialize() {
	...
	//fmt.Println(models.GetCollectors(), "models.collectors")
}
